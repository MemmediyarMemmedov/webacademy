...
<head>
	...
	<title> Blog Page | Admin Panel</title>
	<!-- This page CSS -->
	<!-- chartist CSS -->
	...
	<!-- page CSS -->
	<?php if ($General->CurrentPage() == "portfolio" || $General->CurrentPage() == "blogs" || $General->CurrentPage() == "blog-add" || $General->CurrentPage() == "redakte" ) { ?>
...
<body class="skin-default-dark fixed-layout">
	...
	<div class="preloader">
		<div class="loader">
			...
			<p class="loader__label">Məmmədov Məmmədiyar</p>
		</div>
	</div>
	<!-- ============================================================== -->
