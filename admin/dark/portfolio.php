    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Porfolio</h4>
            </div>
        </div>
        <!-- ============================================================== -->
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($data as $x) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $x['info'] ?></td>
                                            <td><?= $x['link'] ?></td>
                                            <td><input onchange="PortfolioStatus(<?= $x['id'] ?>)" type="checkbox" <?= $x["status"] == 1 ? "checked" : "" ?> class="js-switch" data-color="#f62d51" data-size="small" />
                                            </td>
                                            <td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" value="../../<?=$x['sekil']?>" id="oldimg" name="oldimg" />
                 
                <div class="form-group">
                        <label for="redaktekateqoriya" class="col-form-label">Kateqoriya:</label>
                     <select name="redaktekateqoriya" class="form-control" id="redaktekateqoriya">
                    ...
                    <div class="form-group">
                        ...
                        <img src="" width="60" height="60" id="redaktesekil" alt="" />
                    </div>
                    <div class="form-group">
                        <label>Şəkil (*)</label>
