                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ad" required="required" placeholder="Ad daxil edin.." id="ad" />
                            </div>
                            <div class="form-group">
                                <label for="info">Qeyd</label>
                                <input type="text" class="form-control" name="info" placeholder="Qeyd daxil edin.." id="info" />
                            </div>
                            <div class="form-group">
                                <label for="link">Link</label>
                                <input type="text" class="form-control" name="link" placeholder="Link daxil edin.." id="link" />
                            </div>
