	...
	<!-- ============================================================== -->
	<footer class="footer">
	    ©Web Academy <?= date("Y") == "2017" ? "2017" : "2017 - " . date("Y") ?>
	</footer>
	<!-- ============================================================== -->
	<!-- End footer -->
	<!-- ============================================================== -->
	...
	<!-- This page plugins -->
	<?php if ($General->CurrentPage() == "blog-add" ||$General->CurrentPage() == "redakte") { ?>
	...
	<?php } ?>
	<?php if ($General->CurrentPage() == "portfolio" || $General->CurrentPage() == "blogs") { ?>
	    <!-- ============================================================== -->
	    <!--morris JavaScript -->
